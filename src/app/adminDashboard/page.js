...
export default function AdminDashboard() {
  ...
  const handleImportProducts = async (event) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(
          `Successfully imported ${result.imported} products! ${result.skipped > 0 ? `Skipped ${result.skipped} invalid rows.` : ''}`,
          { id: 'import-toast' }
        );
        ...
        toast.error(result.message || 'Failed to import products', { id: 'import-toast' });
      }
    } catch (error) {
                ...
                {hasProducts && (
                  <div className="flex items-center gap-2">
                    <button 
                      ...
                      className="px-4 py-2 border border-[#c9cccf] text-[#303030] text-[13px] font-medium rounded-lg hover:bg-gray-50"
                    >
                      Export
                    </button>
                    <label className="px-4 py-2 border border-[#c9cccf] text-[#303030] text-[13px] font-medium rounded-lg hover:bg-gray-50 cursor-pointer">
                      Import
                      <input
                        type="file"
                        accept=".csv"
                    ...
                    <a href="/adminDashboard/AddProduct" className="px-4 py-2 bg-[#303030] text-white text-[13px] font-semibold rounded-lg hover:bg-[#1a1a1a]">
                      Add product
                    </a>
                  </div>
                )}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button 
                          ...
                          className={`px-4 py-2 text-[13px] font-medium rounded-lg ${selectedTab === 'active' ? 'text-[#303030] bg-[#f1f1f1]' : 'text-[#5c5f62] hover:bg-gray-100'}`}
                        >
                          Active
                        </button>
                        <button 
                          onClick={() => setSelectedTab('draft')}
                          className={`px-4 py-2 text-[13px] font-medium rounded-lg ${selectedTab === 'draft' ? 'text-[#303030] bg-[#f1f1f1]' : 'text-[#5c5f62] hover:bg-gray-100'}`}
                        >
                          Draft
                        </button>
                        {/* <button 
                          onClick={() => setSelectedTab('archived')}
                          className={`px-4 py-2 text-[13px] font-medium rounded-lg ${selectedTab === 'archived' ? 'text-[#303030] bg-[#f1f1f1]' : 'text-[#5c5f62] hover:bg-gray-100'}`}
                        >
                          Archived
                        </button> */}
                    ...
                    {selectedProducts.length > 0 && (
                      <div className="px-4 py-3 bg-[#f6f6f7] border-b border-[#e1e1e1] flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          {allSelectedAreDraft ? (
                            <button
                              ...
                              className="px-3 py-1.5 border border-[#c9cccf] bg-white text-[#303030] text-[13px] font-medium rounded-lg hover:bg-gray-50 transition-colors"
                            >
                              Set as active
                            </button>
                          ) : (
                        ...
                        <button
                          ...
                          className="text-[13px] text-[#303030] hover:underline"
                        >
                          Show all selected
                        </button>
                      </div>
                    ...
                    <table className="w-full">
                      <thead className="border-b border-[#e1e1e1]">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left text-[13px] font-medium text-[#303030]">Inventory</th>
                          <th className="px-4 py-3 text-left text-[13px] font-medium text-[#303030]">Category</th>
                          <th className="px-4 py-3 text-right text-[13px] font-medium text-[#303030]">Channels</th>
                        </tr>
                      </thead>
                      <tbody>
                        {filteredProducts.map((product) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-4 py-4">
                                <span className="text-[13px] text-[#303030]">{product.category || '-'}</span>
                              </td>
