...
export default function CreateGiftCardPage() {
  ...
  return (
    <AdminLayout>
      <div className="max-w-[1200px] mx-auto px-4 lg:px-12 py-4 lg:py-6">
        {/* Page Header */}
        <div className="mb-4 lg:mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-[18px] sm:text-[20px] font-semibold text-[#303030]">Create gift card</h1>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full sm:w-auto px-4 py-2 bg-[#303030] text-white text-[13px] font-semibold rounded-lg hover:bg-[#1a1a1a] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div className="col-span-1 lg:col-span-2 space-y-4 lg:space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-visible relative">
              <div className="p-4 lg:p-6 pb-4 lg:pb-8">
      ...
      {showCreateCustomerModal && (
        <div className="fixed inset-0  flex items-center justify-center z-9999 " style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
          ...
          >
            {/* Modal Header */}
            <div className="bg-[#f6f6f7] border-b border-[#e1e1e1] p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <h2 className="text-[16px] sm:text-[18px] font-semibold text-[#303030]">Create a new customer</h2>
                <button
      ...
      {showAddNoteModal && (
        <div className="fixed inset-0 flex items-center justify-center z-9999" style={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>
          ...
          >
            ...
            <div className="bg-[#f6f6f7] border-b border-[#e1e1e1] p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <h2 className="text-[16px] sm:text-[18px] font-semibold text-[#303030]">Add note</h2>
                <button
