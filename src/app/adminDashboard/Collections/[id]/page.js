...
export default function EditCollection() {
  ...
  const handleRemoveImage = async () => {
    ...
    try {
      ...
      await deleteCollectionImage(filename);
      setImageUrl('');
                      ...
                      {loadingProducts ? (
                        ...
                        <div className="space-y-2">
                          {filteredProducts.map((product) => (
                            ...
                            >
                              <input
                                ...
                                className="w-4 h-4 text-[#005bd3] border-gray-300 rounded"
                          ...
                          {selectedProducts.length > 0 && (
                            <p className="text-[13px] text-[#616161] text-center pt-2">
                      ...
                      {imageUrl ? (
                        ...
                        <div className="relative group">
                          <img
                            ...
                            className="w-full h-48 object-cover rounded-lg border border-[#c9cccf]"
                          />
                          <button
                        ...
                        <div className="border-2 border-dashed border-[#c9cccf] rounded-lg p-8 text-center">
                          <div className="flex flex-col items-center gap-3">
                            <label className="px-4 py-2 border border-[#c9cccf] text-[#303030] text-[14px] font-medium rounded-lg hover:bg-gray-50 transition-colors cursor-pointer flex items-center gap-2">
